...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Cria uma matricula a partir de uma string //
// Recebe uma string //
// Devolve uma matricula //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
Matricula cria_matricula(char * matricula) { // cria uma matricula a partir de uma string //
    Matricula mat;
    sscanf(matricula, "%s-%s-%s", mat.par1, mat.par2, mat.par3); 
    // lê a string e guarda os valores nas variáveis //
    mat.par1[2] = '\0'; 
    mat.par2[2] = '\0';
    mat.par3[2] = '\0';
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Ordena as entradas por nome do parque //
// Recebe um array de entradas e o seu tamanho //
// Devolve nada //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
void sort_entradas_nome(Hash_node **entradas, int tamanho) { 
    int i, j;
    Hash_node *key;
    ...
    for (i = 1; i < tamanho; i++) { // para cada entrada //
        ...
        while (j >= 0 && strcmp(entradas[j]->parque->nome, key->parque->nome) > 0) { 
            // enquanto o nome do parque for maior //
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Ordena as entradas por nome do parque e data de entrada //
// Recebe um array de entradas e o seu tamanho //
// Devolve nada //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
void sort_entradas_nome_data(Hash_node **entradas, int tamanho) {
    sort_entradas_nome(entradas, tamanho); 
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Procura as entradas de um veículo //
// Recebe a hashtable e a matricula do veículo //
// Devolve um array de nodes //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
Hash_node ** busca_entradas(Hash_list * hashtable, Matricula matricula) { 
    ...
    entradas = (Hash_node**) malloc(sizeof(Hash_node) * tamanho); 

    for (i = 0; node != NULL && i < tamanho;) { // para cada node da lista de faturações //
        if (mesma_matricula(node->carro->matricula, matricula)) { 
            // se a matricula do carro for igual à matricula procurada //
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Imprime a matricula e data e hora de entrada e saída de um carro //
// Recebe um node //
// Devolve nada //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Imprime as entradas de um veículo //
// Recebe a hashtable e a matricula do veículo //
// Devolve nada //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
void veiculo(Hash_list * hashtable, Matricula matricula) { 
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// Verifica os argumentos e imprime as entradas de um veículo //
// Recebe a hashtable e um array de palavras //
// Devolve nada //
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
void v(Hash_list * hashtable, char ** palavras) { 
